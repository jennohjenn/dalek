...
*/
$da->config['hashing_algorithm'] = 'sha1salt';


/**
* Allow or disallow creation of new user accounts.
*/
$da->config['create_new_users'] = true;


/**
* Define session name
*/
$da->config['session_name'] = preg_replace('/[:\.\/-_]/', '', __DIR__);
...
* Define menus.
*
* Create hardcoded menus and map them to a theme region through $da->config['theme'].
*/
$da->config['menus'] = array(
  'navbar' => array(
...
* Template files can reside in the parent or current theme, the CDalek::ThemeEngineRender()
...
*
* path: Path to current theme, relativly DALEK_INSTALL_PATH, for example themes/grid or site/themes/mytheme.
