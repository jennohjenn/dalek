...
class CCGuestbook extends CObject implements IController {
  ...
  private $pageTitle = 'Dalek Guestbook Example';
  private $pageHeader = '<h1>Guestbook Example</h1><p>Showing off how to implement a guestbook in Dalek. Now saving to database.</p>';
