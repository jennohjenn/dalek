<?php
/**
* A model for managing Dalek modules.
*
* @package DalekCore
*/
...
* Properties
*/
  private $glennCoreModules = array('CDalek', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $glennCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
...
*/
  private function GetDetailsOfModule($module) {
    ...
    if(class_exists($module)) {
      ...
      $details['isDalekCore']         = in_array($rc->name, $this->glennCoreModules);
      $details['isDalekCMF']         = in_array($rc->name, $this->glennCMFModules);
